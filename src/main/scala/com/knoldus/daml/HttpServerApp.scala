...
import com.knoldus.daml.bootstrap.{DaoInstantiator, PopulateTableInstantiator, RouteInstantiator, ServiceInstantiator}
...
object HttpServerApp extends App {
  ...
  try {
    ...
    new PopulateTableInstantiator(daoInstantiator)
